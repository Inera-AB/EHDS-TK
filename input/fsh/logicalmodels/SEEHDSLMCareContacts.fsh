...
* careContact.careContactOrgUnit 0..1 BackboneElement "Enhet för vårdkontakten (Regel 5)"
...
* careContact.careContactTimePeriod 0..1 BackboneElement "Tidsintervall för vårdkontakten (minst ett av start/end måste anges)"
