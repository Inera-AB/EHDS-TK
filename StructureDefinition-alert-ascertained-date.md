# Datum för konstaterande - Inera EHDS Tjänstekontrakt – FHIR Implementation Guide v0.3.3
...
| | |
| :--- | :--- |
| *Official URL*:https://fhir.inera.se/ig/ehds-tk/StructureDefinition/alert-ascertained-date | *Version*:0.3.3 |
